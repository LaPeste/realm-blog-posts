...
Before we start with the deep dive, you should know that the extracts of code that you are going to see in this blog-post can be found in our [example repo](https://github.com/LaPeste/realm-blog-posts/tree/main/migration-blog-post). The project uses [preprocessor directives](https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/preprocessor-directives) to drive the various migrations; more on this later. But suffice to say that in order to see the full flow of the schema migrations you must define the *symbol* `SCHEMA_VERSION_1`, then build the project and, finally, run the resulting **dll**. Then, define `SCHEMA_VERSION_2`, rebuild and rerun the compiled binary. And as the last migration step, define `SCHEMA_VERSION_3` and redo the, already mentioned, build and run. A more in-depth guide on how to run the project can be found in [`MigrationTutorial/README.md`](https://github.com/LaPeste/realm-blog-posts/blob/main/migration-blog-post/MigrationTutorial/README.md).
...
## Code Overview
In order to help you browsing faster through the [code](https://github.com/LaPeste/realm-blog-posts/tree/main/migration-blog-post) of this tutorial I will briefly go over the structure of the project.
